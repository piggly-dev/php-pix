...
class StaticPayloadCreationTest extends TestCase
{
	...
	public static function dataPix () : array
	{
		...
		for ( $i = 0; $i < 100; $i++ )
		{
			...
			// Key
			$pixData = array_merge($pixData, static::_getRandomKey($faker));
	 ...
	 * @return array
	 */
	private static function _getRandomKey ( $faker ) : array
	{
		...
		switch ( $num )
		{
			...
			case 4:
				return ['KEY_TYPE' => Parser::KEY_TYPE_RANDOM, 'KEY_VALUE' => static::_genUuid()];
		}
	}
	 ...
	 * @return string|null
	 */
	private static function _replacesChar ( ?string $str ) : ?string
	{
		if ( \is_null($str) )
		{ return null; }
