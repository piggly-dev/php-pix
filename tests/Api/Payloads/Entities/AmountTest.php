...
class AmountTest extends TestCase
{
	 ...
	 * @return array
	 */
	public static function dataAmounts () : array
	{
		$arr = [];
		...
		for ( $i = 0; $i < 100; $i++ )
		{
			...
			if ( $faker->boolean() )
			{ $payload[DueAmountModality::MODALITY_BANKFINE] = static::_getModality($faker, DueAmountModality::MODALITY_BANKFINE)->export(); }

			if ( $faker->boolean() )
			{ $payload[DueAmountModality::MODALITY_DISCOUNT] = static::_getModality($faker, DueAmountModality::MODALITY_DISCOUNT)->export(); }

			if ( $faker->boolean() )
			{ $payload[DueAmountModality::MODALITY_FEE] = static::_getModality($faker, DueAmountModality::MODALITY_FEE)->export(); }

			if ( $faker->boolean() )
			{ $payload[DueAmountModality::MODALITY_REDUCTION] = static::_getModality($faker, DueAmountModality::MODALITY_REDUCTION)->export(); }
	...
	public static function dataFormats () : array
	{
		...
		for ( $i = 0; $i < 100; $i++ )
		{
			...
			$modality = static::_getModality($faker, DueAmountModality::MODALITY_BANKFINE);
	 ...
	 */
	private static function _getModality ( $faker, $type ) : DueAmountModality
	{
		switch ( $type )
		{
